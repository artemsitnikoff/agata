...
class Settings(BaseSettings):
    ...
    # Многие боты сначала шлют плейсхолдер «идёт поиск… подождите», а затем
    # РЕДАКТИРУЮТ это сообщение готовым результатом. Пока на руках только
    # плейсхолдер — ждём его правку (или новое сообщение) до этого лимита (сек).
    ask_edit_timeout: float = 30.0
